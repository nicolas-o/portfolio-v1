...
export const spanish = [
  {
    ...
    sobreMi: [
      ...
      " de Estados Unidos. Me gusta mucho lo que me enseñan en la universidad pero siento que no satisface todas mis ganas de aprender así que hace un año que estoy buscando adquirir por mi cuenta conocimientos más avanzados que me han llevado a mejorar mis habilidades.",
...
export const english = [
  {
    ...
    sobreMi: [
      "ABOUT ME",
      "Hello! My name is Nicolas Orellana. I'm very passionate about web technology and I'm currently focusing on Front-End Development. I'm majoring in a BS in Applied Technology at ",
      ". I like what they teach me, but I feel that it doesn't satisfy my desire to learn, that's why I started to seek and learn advanced knowledge by taking internet courses so that I can improve my abilities even more.",
    ...
    queHago: [
      "WHAT I DO",
      "DEVELOPMENT",
      "I started programming some applications in python for the university. Later, when I learned HTML, CSS, and Javascript, I fell in love with web development. Today I'm studying and developing applications in React using ES6 syntax. My goal is to become Full Stack Developer.",
      "DESIGN",
